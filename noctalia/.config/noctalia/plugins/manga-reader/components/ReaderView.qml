...
Item {
        ...
        RowLayout {
            ...
            Item {
                ...
                MouseArea {
                    ...
                    hoverEnabled: true
                    onClicked: {
                        mainInstance.clearChapterPages()
            ...
            // Page counter badge
            Rectangle {
                visible: mainInstance.chapterPages.length > 0
                height: 24
                ...
                Text {
                    id: pageCountText
                    anchors.centerIn: parent
                    text: (pageListView.currentIndex + 1) + " / " + mainInstance.chapterPages.length
    ...
    Rectangle {
        anchors.fill: parent
        color: "#08080a"
        visible: mainInstance.isFetchingPages
        z: 8
    ...
    Rectangle {
        anchors.fill: parent
        color: "#08080a"
        visible: mainInstance.pagesError.length > 0 && !mainInstance.isFetchingPages
        z: 7
    ...
    ListView {
        ...
        model: mainInstance.chapterPages
        spacing: 3
    ...
    Item {
        ...
        // Fill
        Rectangle {
            width: mainInstance.chapterPages.length > 0
                ? parent.width * ((pageListView.currentIndex + 1) / mainInstance.chapterPages.length)
                : 0
