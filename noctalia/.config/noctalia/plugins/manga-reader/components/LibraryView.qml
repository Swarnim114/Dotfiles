...
Item {
    ...
    ColumnLayout {
        ...
        Item {
            ...
            visible: mainInstance.libraryList.length === 0 && mainInstance.libraryLoaded
        ...
        Item {
            Layout.fillWidth: true
            Layout.fillHeight: true
            visible: !mainInstance.libraryLoaded
        ...
        GridView {
            ...
            Layout.fillWidth: true
            Layout.fillHeight: true
            visible: mainInstance.libraryList.length > 0
            topMargin: 10
            leftMargin: 8
            rightMargin: 8
            bottomMargin: 10
            ...
            model: mainInstance.libraryList
            ...
            delegate: Item {
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        hoverEnabled: true
                        onClicked: {
                            mainInstance.fetchMangaDetail(libEntry.id)
