    ...
    ColumnLayout {
                ...
                Rectangle {
                    ...
                    TextInput {
                        ...
                        Keys.onEscapePressed: {
                            ...
                            text = ""
                            mainInstance.fetchByOrigin(browseView.currentTagId, true)
                        }
                    }
                ...
                Timer {
                    ...
                    onTriggered: {
                        if (searchField.text.trim().length > 0)
                            mainInstance.searchManga(searchField.text.trim(), true)
                        else
                            mainInstance.fetchByOrigin(browseView.currentTagId, true)
                    }
                }
                ...
                delegate: Item {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            searchField.text = ""
                            searchBar.visible = false
                            mainInstance.fetchByOrigin(tagId, true)
                        }
                    }
                }
            }
        ...
        Item {
            ...
            Rectangle {
                anchors.fill: parent
                color: c.background
                visible: mainInstance.isFetchingManga && mainInstance.mangaList.length === 0
                z: 10
            ...
            Rectangle {
                anchors.fill: parent
                color: c.background
                visible: mainInstance.mangaError.length > 0 && !mainInstance.isFetchingManga
                z: 9
            ...
            GridView {
                ...
                onContentYChanged: {
                    if (contentY + height > contentHeight - cellHeight * 2)
                        mainInstance.fetchNextMangaPage()
                }
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            hoverEnabled: true
                            onClicked: {
                                mainInstance.fetchMangaDetail(modelData.id)
