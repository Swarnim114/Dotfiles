...
Item {
    ...
    readonly property bool _inLibrary:
        mainInstance.currentManga ? mainInstance.isInLibrary(mainInstance.currentManga.id) : false
    ...
    readonly property var _processedChapters: {
        if (!mainInstance.currentManga) return []
        let chapters = mainInstance.currentManga.chapters.slice()
    ...
    ColumnLayout {
            ...
            RowLayout {
                ...
                Item {
                    ...
                    MouseArea {
                        ...
                        onClicked: { mainInstance.clearChapterList(); detailView.backRequested() }
                    }
                }

                Text {
                    Layout.fillWidth: true
                    text: mainInstance.currentManga ? mainInstance.currentManga.title : ""
                ...
                // ── Library toggle ────────────────────────────────────────────
                Item {
                    visible: mainInstance.currentManga !== null
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            if (detailView._inLibrary)
                                mainInstance.removeFromLibrary(mainInstance.currentManga.id)
                            else
                                mainInstance.addToLibrary({
                                    id:       mainInstance.currentManga.id,
                                    title:    mainInstance.currentManga.title,
                                    coverUrl: mainInstance.currentManga.coverUrl
                                })
                        }
                    }
                }
        ...
        Item {
            Layout.fillWidth: true
            Layout.preferredHeight: mainInstance.currentManga !== null ? 160 : 0
            clip: true
            ...
            Image {
                anchors.fill: parent
                source: mainInstance.currentManga ? mainInstance.currentManga.coverUrl : ""
            ...
            Row {
                ...
                Column {
                    ...
                    // Status badge
                    Rectangle {
                        visible: mainInstance.currentManga && mainInstance.currentManga.status.length > 0
                        ...
                        Text {
                            ...
                            text: mainInstance.currentManga ? (mainInstance.currentManga.status || "").toUpperCase() : ""
                            font.family: detailView.fontBody
                    ...
                    Text {
                        width: parent.width
                        text: mainInstance.currentManga ? (mainInstance.currentManga.authors || []).join(", ") : ""
                        font.family: detailView.fontBody
                    ...
                    Text {
                        width: parent.width
                        text: mainInstance.currentManga ? mainInstance.currentManga.description : ""
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Text {
                    text: mainInstance.currentManga ? mainInstance.currentManga.chapters.length + " chapters" : ""
                    font.family: detailView.fontBody
                ...
                // Last-read badge
                Rectangle {
                    readonly property var _entry: mainInstance.currentManga
                        ? mainInstance.getLibraryEntry(mainInstance.currentManga.id) : null
                    ...
                    Text {
                        ...
                        text: {
                            var e = mainInstance.currentManga
                                ? mainInstance.getLibraryEntry(mainInstance.currentManga.id) : null
        ...
        Item {
            ...
            Rectangle {
                ...
                visible: mainInstance.isFetchingDetail; z: 5
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    readonly property var _libEntry: mainInstance.currentManga
                        ? mainInstance.getLibraryEntry(mainInstance.currentManga.id) : null
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            mainInstance.fetchChapterPages(modelData.id)
                            detailView.chapterSelected(modelData.id)
                            if (mainInstance.currentManga && mainInstance.isInLibrary(mainInstance.currentManga.id)) {
                                mainInstance.updateLastRead(
                                    mainInstance.currentManga.id,
                                    modelData.id,
                                    modelData.chapter
                                )
                            }
